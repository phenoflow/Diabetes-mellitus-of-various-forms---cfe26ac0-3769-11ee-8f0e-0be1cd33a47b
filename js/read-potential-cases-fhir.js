...
(async () => {
  ...
  await fs.writeFile("diabetes-mellitus-of-various-forms-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("diabetes-mellitus-of-various-forms-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
